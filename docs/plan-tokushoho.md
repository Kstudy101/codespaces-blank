...
> **상태: 승인·표기 문안 대기.** A5에서 `TOKUSHOHO_URL` 이 사이트(`kstudy101.jp`)를
> 가리키면 본 페이지가 **404** — 결제 가격표의 「販売者の表記」 링크가 깨진다.
> 2026-08-07 실측: `https://www.kstudy101.jp/tokushoho` → **404**.
...
- [ ] §1 표기 9항 확정 (대표)
- [ ] `TOKUSHOHO_URL` 이 `kstudy101.jp` 인지 확인 (대표)
- [ ] 본 계획 승인
- [ ] HTML + 4곳 + verify 구현
- [ ] 사이트 배포 (main push)
